...
struct HomeView2: View, HomeManagerDirectAccess {
    ...
    init(manager: HomeManager) {
        ...
        //changeTheme(to: AppTheme(name: "HHG", primaryuiColor: UIColor(Color("Blue")), complementaryuiColor: UIColor.white))
    }
